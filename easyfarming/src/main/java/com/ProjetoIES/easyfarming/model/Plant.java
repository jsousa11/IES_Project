...
public class Plant{
    ...
    public Plant(String name, String image, String description, String classs, String family, String genus, String kingdom, String orderr, String phylum){
        this.name = name;
        this.image = image;
    ...
    public String toString() {
        return "Client [Name=" + name + ", Image=" + image + ", Id=" + id + ", Description=" + description
